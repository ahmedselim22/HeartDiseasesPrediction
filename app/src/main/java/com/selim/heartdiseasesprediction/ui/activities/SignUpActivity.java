...
import com.selim.heartdiseasesprediction.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp(){
        ...
        String userName =binding.signUpEtFirstName.getText().toString().concat(binding.signUpEtLastName.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.DOC_ID,documentReference.getParent().getId().toString());
    ...
    private boolean isSignUpDetailsIsValid(){
        ...
        else if (binding.signUpEtFirstName.getText().toString().trim().isEmpty()){
            showToast("Enter First Name");
            return false;
        }
        else if (binding.signUpEtLastName.getText().toString().trim().isEmpty()){
